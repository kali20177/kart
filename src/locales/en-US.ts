export default {
  ...
  conn: {
    ...
    baudRate: 'Baud Rate',
    baudTip: 'Baud rate: symbols per second, must match the device; typical 9600 / 115200',
    dataBitsTip: 'Data bits: data bits per frame. 8 is most common; older devices may use 7, some use 5/6',
    parityTip: 'Parity: error detection. None = no parity bit; Even/Odd adds a parity bit',
    stopBitsTip: 'Stop bits: idle bits after each frame. 1 is standard; 2 for slow devices, 1.5 is rare',
    connect: 'Connect',
