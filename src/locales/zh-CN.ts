export default {
  ...
  conn: {
    ...
    refreshPorts: '刷新端口列表',
    baudRate: '波特率',
    baudTip: '波特率：每秒传输的符号数，需与设备一致；常用 9600 / 115200',
    dataBitsTip: '数据位：一帧中的数据比特数。常用 8；旧设备可能用 7，少数用 5/6',
    parityTip: '校验位：检测传输错误。None 不加校验位，Even 偶校验，Odd 奇校验',
    stopBitsTip: '停止位：帧结束后的空闲比特数。常用 1；2 用于慢速设备，1.5 极少见',
    connect: '连接',
    disconnect: '断开',
    mockScene: '模拟场景',
    asciiTable: 'ASCII 表',
